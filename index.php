...
<html lang="en">
  <head>
    ...
    <style>
      *{
      ...
      #stu-form{
        min-height:100vh;
        background:url(interior_design.jpg);
        background-repeat: no-repeat;
        background-position: center;
        background-attachment: fixed;
        background-size: cover;
  ...
  <body>
    ...
    <div class="container-fluid d-flex justify-content-center align-items-center" id="btn-container">
      <div class="d-flex flex-column justify-content-center iconic dingu">
    ...
    <div class="container-fluid d-flex justify-content-center align-items-center" id="teach-form">
      <div class="login" onmouseover="second(this)" onmouseout="first(this)">
        <h1 class="login-header dhanno">REGISTER</h1>
        <form action="check.php" method="POST">
        <div class="textbox">
          <i class="fas fa-user rego"></i>
          <input class=" dhanno" type="text" value="" name="uname" placeholder="Username" onclick="changeIcon(this)"/>
        </div>
        <div class="textbox">
          <i class="fas fa-envelope rego"></i>
          <input class=" dhanno" type="text" value="" name="email" placeholder="Email" onclick="changeIcon(this)"/>
        </div>
        <div class="textbox">
          <i class="fas fa-phone rego"></i>
          <input class=" dhanno" type="text" value="" name="mobile_no" placeholder="Contact No." onclick="changeIcon(this)"/>
        </div>
        <div class="textbox">
          <i class="fas fa-lock rego"></i>
          <input class=" dhanno" type="password" value="" name="password" placeholder="Password" onclick="changeIcon(this)"/>
        </div>
        <input type="submit" value="Sign in" class="submit dhanno" name="register_btn" />
        <?php
    ...
    <script  type="text/javascript">
        ...
        const quotes=["Welcome to PG Searcher","We've got the Best PGs for you","Personalized suggestions only for you"];
        let curr=0;
        function printmsg()
        {
          msg=quotes[curr];
        ...
        const bgds=document.querySelectorAll(".login");
        function first(form){
          const bkg=form.parentElement;
          bkg.style.background="url(interior_design.jpg)";
          bgds.forEach(function(bgd){
            bgd.style.background="lightgreen";
          });
        }
