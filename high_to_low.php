<?php
    ...
    $sql="Select * from home_register,person_register where home_register.city='$city_to_be_searched' and home_register.email=person_register.email order by price desc";
